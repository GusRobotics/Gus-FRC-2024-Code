...
public class SwerveModule {
        ...
        // Moves the angle motor (or we can use PID controller built-n to moro
        // controller)
        private final PIDController turningPidController;

        // every time robot is powered off, the motor's enocders lose previous readings
        // Absolute Encoder allows robot to always figure out where robot's wheels are
        // facing
        ...
        public SwerveModule(int driveMotorId, int turningMotorId, boolean driveMotorReversed,
                        boolean turningMotorReversed, int absoluteEncoderId, double abosluteEncoderOffset,
                ...
                // Sets encoder conversion constants so we can work with meters and radians
        ...
        // Function to give motors the values of the absolute encoder which always know
        // their locations bc they always reset
        // Reset drive motor encoder to 0 and the turning encoder to be the absolute
        // encoder value
        ...
        public void setDesiredState(SwerveModuleState state) {
                {
                        // as soon as you let go of controller wpilib resets module state back to 0
                        // degrees
                        // if statement below prevents this
                        // checks if there's no substantial driving velocity to determine if we can
                        // ignore the resetting
